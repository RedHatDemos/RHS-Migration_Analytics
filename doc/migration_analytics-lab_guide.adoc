...
Once the overview is done, we can proceed by going back to, via SSH, to the `workstation`. 
...
. Once we click on *falidate* we can ensure that the credentials are OK and we can proceed to click the *Add* at the bottom of the page.
+
