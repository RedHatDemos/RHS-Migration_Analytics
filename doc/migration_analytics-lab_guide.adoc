...
[NOTE]
These steps are reproduced later on in the lab.
...
The Migration Analytics service is running as an application on the OpenShift instances that power cloud.redhat.com. 
